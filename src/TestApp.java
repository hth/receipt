...
public class TestApp {
	 ...
	 * 
	 * Recognized result will be saved in special format for business cards: vCard, csv or xml
	 */
	...
	/**
	 * Extract value of given parameter from command-line parameters. Parameter is removed after extraction
	 * 
	 * @return value of parameter or null
	 */
	private static String extractParameterValue(String parameterName, Vector<String> args) {
	...
	/**
	 * Extract recognition language from command-line parameters. After extraction parameter is removed
	 * 
	...
	/**
	 * Extract extra RESTful options from command-line parameters. Parameter is removed after extraction
	 * 
