...
<p>
    <a href="http://${domain}/forgot/authenticate.htm?authenticationKey=${link}">Reset your Receiptofi ID password ></a>
...
<br/>
<img src="cid:receiptofi.logo" alt="receipt-o-fi logo" height="40px" width="240px">
</body>
</html>