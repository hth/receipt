...
<head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/static/external/js/angular/angular-animate.min.js"></script>
    <script type="text/plain" src="${pageContext.request.contextPath}/static/external/js/angular/angular-animate.min.js.map"></script>
