                ...
                <table style="width: 600px" class="etable">
                    ...
                    <tr>
                        ...
                        <td style="padding:5px;">
                            <spring:eval expression="receipt.level.description" />
                        </td>
                        <td style="padding:5px;">
                        ...
                        <td style="padding:5px; text-align: right" title="${receipt.documentId}">
                            <a href="${pageContext.request.contextPath}/emp/receipt/update/${receipt.documentId}.htm" target="_blank">
                                Open
                            </a>
                        </td>
                    </tr>
            ...
            <div class="down_form" style="width: 95%;">
                ...
                <table style="width: 600px" class="etable">
                    ...
                    <tr>
                        ...
                        <td style="padding:5px; text-align: right" title="${receipt.documentId}">
                            <a href="${pageContext.request.contextPath}/emp/receipt/update/${receipt.documentId}.htm">
                                Open
                            </a>
                        </td>
                    </tr>
            ...
            <div class="down_form" style="width: 95%;">
                ...
                <table style="width: 600px" class="etable">
                    ...
                    <tr>
                        ...
                        <td style="padding:5px; text-align: right" title="${receipt.documentId}">
                            <a href="${pageContext.request.contextPath}/emp/receipt/recheck/${receipt.documentId}.htm">
                                Open
                            </a>
                        </td>
                    </tr>
