...
<div class="main clearfix">
    ...
    <div class="rightside-list-holder full-list-holder" style="overflow-y: hidden; height: 800px;">
        <div class="down_form" style="width: 95%;">
            <h2 class="h2" style="padding-bottom:5%;"><a href="/admin/searchUser.htm">Search User</a></h2>
            <h2 class="h2" style="padding-bottom:5%;"><a href="/admin/business.htm">Search Business</a></h2>
        </div>
    </div>
