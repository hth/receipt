...
import com.receiptofi.loader.scheduledtasks.MailProcessITest;
...
public class LoadResource {
    ...
    public static void loadProperties(Properties properties) throws IOException {
        if (properties.keySet().isEmpty()) {
            ...
            File[] profileDir = findFiles(MailProcessITest.class.getResource("").getPath().split("service")[0] + LoadResource.BUILD, LoadResource.profileF);
